                    ...
                    <div class="md:col-span-2 mt-5 md:mt-0">
                        <div class="shadow bg-white md:rounded-md p-4">
                            <form @submit.prevent="submit">
                                ...
                                <!-- <textarea name="" id="" cols="30" rows="10" class="form-input w-full rounded-md shadow-sm"></textarea> -->
                                ...
                                <textarea v-model="form.content" rows="8" class="form-input w-full rounded-md shadow-sm"></textarea>
